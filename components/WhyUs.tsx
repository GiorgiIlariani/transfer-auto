...
const WhyUs = () => {
  return (
    <section className="w-full py-20">
      ...
      <div className="flex items-center gap-[46px] mt-[46px]">
        <div className="flex flex-col gap-5">
          {whyUsOptions.map((option, index) => (
            ...
            >
              <div className="flex items-center gap-4 w-[684px]">
                <div
        ...
        <div className="bg-[#F9F5FF] rounded-[16px] w-[550px] h-[468px] flex items-center justify-end">
          <Image
